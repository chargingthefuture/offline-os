...
- **No sentence of the form "that is the whole ‹anything›", and no "point of the thing"**
  (owner directives, 2026-08-28 and 2026-08-29, widened 2026-09-13). One habit: a sentence
  that arrives after the facts to tell the reader which of them mattered. State the point
  plainly and stop; if a sentence does nothing but label what came before it, delete it. The
  ban is on the construction rather than a list of nouns, because three nouns were banned one
  at a time and the writing reached for a fourth each time. A negated form is left alone.
